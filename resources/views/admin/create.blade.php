    ...
    <form action="{{route('cards.store')}}" method="POST">
        ...
        <div class="bg-primary p-3 shadow d-flex justify-content-between">
            <div class="d-flex gap-2 align-items-center">
                ...
                <h4 class="fw-bold text-white m-0">Agregar nueva carta</h4>
            </div>
        ...
        <div class="row mt-3">
            <div class="col col-md-6">
                <label class="w-100 font-spicy text-white d-flex flex-column fs-4">
                    Nombre
                    <input class="form-control bg-primary" name="name" required type="text">
                </label>
                <label class="w-100 font-spicy text-white d-flex flex-column fs-4">
                    SVG
                    <textarea id="txtSvg" class="form-control bg-primary" required name="svg" id="" cols="30" rows="10"></textarea>
                </label>
            </div>
